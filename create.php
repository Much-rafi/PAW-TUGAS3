...
if (isset($_POST["submit"])) {
    ...
    $Alamat = $_POST["Alamat"];
    $Durasi = $_POST["Durasi"];
    $insert = mysqli_query($konek, "INSERT INTO rafi_089 values('', '$Nama', '$Umur', '$Alamat', '$Durasi')");
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Tambahkan Penghuni Kos</h5>
...
<!-- 
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Tanggal masuk</label>
                      <input type="date" name="tanggal" class="form-control"  required/>
                      <div class="invalid-feedback">masukan tanggal masuk anda!</div>
                    </div> -->
                    <div class="col-12">
                      <button type="submit" class="btn btn-primary w-100" name="submit" >Masukkan Data</button>
                    </div>
